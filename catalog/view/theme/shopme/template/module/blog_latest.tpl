<div class="box">
<h3 class="panel_header"><?php echo $heading_title_latest; ?></h3>
<div class="bordered_content">
<?php if(!empty($posts)){ ?>
<div class="grid_holder grid<?php echo $columns; ?>">
<div class="product-grid latest_blogs home_latest_blogs m<?php echo $module; ?> <?php if ($carousel) { ?>carousel<?php } ?>">
