...
class ControllerModuleNewsletter extends Controller {
	public function index($setting) {
		...
		if (file_exists('catalog/view/theme/' . $this->config->get('config_template') . '/stylesheet/newsletter.css')) {
		$this->document->addStyle('catalog/view/theme/' . $this->config->get('config_template') . '/stylesheet/newsletter.css');
		} else {
