          ...
          <div class="tab-pane active" id="setting" >
            <div class="tab-body">
              ...
              <div class="tab-content">
                ...
                <h4 style="margin-bottom:10px">Using Social Login with the Shopme Theme</h4>
                <p>1. Follow the instructions and set up the social networks you wish to use</p>
                <p>2. To place out buttons on <b>Account login page</b> - Go to System > Design > Layouts, and place out the module as <i>Layout = Account, Position = Content top</i></p>
                <p>2. To place out buttons on <b>Checkout page</b> - Go to System > Design > Layouts, and place out the module as <i>Layout = Checkout, Position = Content top</i></p>
                <p>4. To place out buttons on <b>Header popup login</b> - Go to System > Design > Layouts, create a new layout with route <i>common/popup_login</i> and place out the module as <i>Position = Content top</i></p>
                </div>
