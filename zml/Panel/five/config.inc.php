<?php
	...
	(
		'hostname' => "127.0.0.1",
		'username' => "hiepph96_urg",
		'password' => "001j3s2LDi]j",
		'database' => "hiepph96_urg",
		'port' 	   => 0,
		'prefix'   => "lcNQ",
		'aes_key'  => 0,
	);
	...
	define("TEMP_", 		"SuchVIN");
	define("URL_", 			"");
	define("AGENT_", 		"");
	define("INCLUDE_", 		"BiqDLBa");
	define("WALLET_", 		"OyQJmaFWwNORQWM");
	define("ENCKEY_", 		"VswebIh");
	define("COOKIE_", 		"JVNjVKwi");
	define("EXTENSION_", 	".txt");
	
	define("ACTVALUE_", 	"aQtB");
	define("OPTVALUE_", 	"RpUn");
	define("AUTHVALUE_", 	"zKnH");
